...
dispatcher.add_handler(CommandHandler('social', callback=social, filters=(Filters.group | Filters.private)))
...
dispatcher.add_handler(CommandHandler('add', callback=add, filters=Filters.private))
